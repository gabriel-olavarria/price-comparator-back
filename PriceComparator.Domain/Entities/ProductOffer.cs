...
public sealed class ProductOffer
{
    ...
    public ProductOffer(string name, decimal price, Store store, Uri productUrl, Uri? imageUrl = null, string? brand = null, string? sellerName = null, string? sellerType = null, IEnumerable<string>? categories = null, string? availability = null)
    {
        ...
        ProductUrl = productUrl ?? throw new ArgumentNullException(nameof(productUrl));
        ImageUrl = imageUrl;
